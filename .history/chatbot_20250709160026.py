...
def get_bot_response(user_input):
    ...
    if any(word in user_input for word in ["hi", "hello", "hey", "hii", "hlo", "namaste", "yo"]):
        return (
            "Hii cutieee 💕! I'm your AI Career Buddy 🤖✨\n"
    ...
    # 🙃 Motivation
        ...
        return (
            "Ayy bujiii 🥺 don't worry… You’re doing amazing 💖 Take a breath, smile 😊, and let's get back on track 💫"
        )

    # 💝 Gratitude
    elif any(word in user_input for word in ["thank you", "thanks", "thankyou", "tnx"]):
        return (
            "Awww you're most welcome bujiii 🌷💖\nYou're the real rockstar 🌟 Keep shining always!"
        )
