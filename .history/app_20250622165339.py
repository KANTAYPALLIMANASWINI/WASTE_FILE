...
def get_reply(user_input):
    ...
    if "resume" in user_input:
        ...
        return "Sorry frienduu 😅 I don’t know that yet. Ask about your resume, jobs or skills!"
...
if st.button("Ask"):
    if user_input:
        ...
        st.warning("Type something frienduu 💬")

st.caption("Made with 💖 by Manaswini & her ChatGPT frienduu 😘")
